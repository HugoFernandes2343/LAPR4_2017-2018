...
//                InfiniteDataView.DYNAMIC_VIEW, new PersonDataSource(personService));    	
        ...
        customTable.setRowFactory(new PersonRowFactory()); 
        ...
        customTable.setCategoryFactory(new CustomCategoryFactory());
        ...
        customTable.setRenderer(new CustomRenderer<>());      
        ...
        for(int k = 1; k <= 2; k++){
            ...
            for(int i = 1; i <= 10; i++, rowIndex++){
                ...
                people.add(new Person(i, "http://joashpereira.com/templates/material_one_pager/img/avatar1.png", "Field " + rowIndex, "Field " + i, "Field " + rowIndex, "No " + i,"Category " + "1"));  
