...
import pt.isep.nsheets.client.application.table.ContactDatabase;
import pt.isep.nsheets.client.application.table.ContactDatabase.Category;
import pt.isep.nsheets.client.application.table.ContactDatabase.ContactInfo;

class SmartSheetViewView extends ViewImpl implements SmartSheetViewPresenter.MyView {

	interface Binder extends UiBinder<Widget, SmartSheetViewView> {
	}
	...
	@Inject
	SmartSheetViewView(Binder uiBinder) {
		 /*
...
//	    });
	    ...
	    dataGrid.addColumn(ageColumn, new SafeHtmlHeader(SafeHtmlUtils.fromSafeConstant("Age")), ageFooter);
...
//	    });
	...
	// if (slot == SmartGwtViewPresenter.SLOT_SmartGwtView) {
