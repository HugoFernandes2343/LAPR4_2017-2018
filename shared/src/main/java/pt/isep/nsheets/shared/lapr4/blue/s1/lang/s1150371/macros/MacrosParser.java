...
public class MacrosParser extends Parser {
	...
	public static class CalculateContext extends InputContext {
		...
		public TerminalNode EOF() { return getToken(MacrosParser.EOF, 0); }
		public TerminalNode NL() { return getToken(MacrosParser.NL, 0); }
		public CalculateContext(InputContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MacrosVisitor ) return ((MacrosVisitor<? extends T>)visitor).visitCalculate(this);
	...
	public static class ToSetVarContext extends InputContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MacrosVisitor ) return ((MacrosVisitor<? extends T>)visitor).visitToSetVar(this);
			else return visitor.visitChildren(this);
		}
	}
